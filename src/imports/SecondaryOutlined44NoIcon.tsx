import svgPaths from "./svg-3665b0b55z";

export default function SecondaryOutlined44NoIcon() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center px-[24px] py-[8px] relative rounded-[25px] size-full" data-name="secondary_outlined_44_no_icon">
