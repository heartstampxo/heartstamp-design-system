...
const SHARED_TOKENS: Record<string, string> = {
  ...
  "--font-family-promo":          "'Oldstyle Italic HPLHS', 'EB Garamond', Georgia, serif",
  /* Weight scale · pair with any --font-size-* / --line-height-* */
  ...
  "--line-height-subheadline":       "32px",
  "--font-size-subheadline-md":      "24px",
  "--font-weight-subheadline-md":    "500",
  "--letter-spacing-subheadline-md": "0em",
  "--line-height-subheadline-md":    "32px",
  "--font-size-body-15":          "15px",
  "--font-weight-body-15":        "400",
  "--line-height-body-15":        "20px",
  "--font-size-label-15":         "15px",
  "--font-weight-label-15":       "500",
  "--line-height-label-15":       "20px",
  "--font-size-label-sb-15":      "15px",
  "--font-weight-label-sb-15":    "600",
  "--line-height-label-sb-15":    "normal",
  "--font-size-label-12":         "12px",
  "--font-weight-label-12":       "500",
  "--line-height-label-12":       "18px",
  "--font-size-label-12-bd":      "12px",
  "--font-weight-label-12-bd":    "700",
  "--line-height-label-12-bd":    "18px",
  "--font-size-body-13":          "13px",
  "--font-weight-body-13":        "400",
  "--line-height-body-13":        "normal",
  "--font-size-body-13-bd":       "13px",
  "--font-weight-body-13-bd":     "700",
  "--line-height-body-13-bd":     "normal",
  /* Promo · Oldstyle Italic HPLHS decorative styles */
  "--font-weight-promo":                "400",
  "--font-size-promo-subheadline":      "32px",
  "--line-height-promo-subheadline":    "40px",
  "--letter-spacing-promo-subheadline": "0em",
  "--font-size-promo-accent":           "24px",
  "--line-height-promo-accent":         "32px",
  "--letter-spacing-promo-accent":      "0.02em",
  "--font-size-promo-caption":          "18px",
  "--line-height-promo-caption":        "26px",
  "--letter-spacing-promo-caption":     "0.01em",
  /* ── Input ──────────────────────────────────────────────── */
...
export const DARK_THEME: Record<string, string> = {
  ...
  /* Primary-ghost – dark mode overrides */
  "--btn-primary-ghost-color": "var(--color-text-link)",
  "--btn-primary-ghost-bg":    "var(--color-brand-secondary-dim)",
...
export const LIGHT_THEME: Record<string, string> = {
  ...
  /* Primary-ghost – light mode */
  "--btn-primary-ghost-color": "var(--color-brand-primary)",
  "--btn-primary-ghost-bg":    "var(--color-brand-primary-dim)",
